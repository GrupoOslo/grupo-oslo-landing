    ...
    <div>
      ...
      >
        <ul className="text-center py-4">
          <li className="py-2">
            <a href="#manifiesto" className="uppercase">
              Manifiesto
            </a>
          </li>
          <li className="py-2">
            <a href="#unidades" className="uppercase">
              Unidades
            </a>
          </li>
          <li className="py-2">
            <a href="#liderazgo" className="uppercase">
              Equipo
            </a>
          </li>
          <li className="py-2">
            <a href="#partners" className="uppercase">
              Partners
            </a>
          </li>
          <li className="py-2">
            <a href="#prefooter" className="uppercase">
              Contacto
            </a>
          </li>
        </ul>
